...
// Region
export const SAVE_REGION_SUCCESS = 'SAVE_REGION_SUCCESS'
export const SAVE_REGION_FAIL = 'SAVE_REGION_FAIL'
export const EDIT_REGION_SUCCESS = 'EDIT_REGION_SUCCESS'
export const EDIT_REGION_FAIL = 'EDIT_REGION_FAIL'
export const REGION_FETCH_ALL_SUCCESS = 'REGION_FETCH_ALL_SUCCESS'
export const REGION_FETCH_ALL_FAIL = 'REGION_FETCH_ALL_FAIL'
export const REGION_DELETE_SUCCESS = 'REGION_DELETE_SUCCESS'
export const REGION_DELETE_FAIL = 'REGION_DELETE_FAIL'
export const REGION_UPDATE_LIST = 'REGION_UPDATE_LIST '
export const REGION_FETCH_DETAILS_SUCCESS = 'REGION_FETCH_DETAILS_SUCCESS'
export const REGION_FETCH_DETAILS_FAIL = 'REGION_FETCH_DETAILS_FAIL'
