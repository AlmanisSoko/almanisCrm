...
class TradeInComponent extends React.Component {
            ...
            <div className="main-panel">
                <div className="content-wrapper">
                    ...
                    <div className="page-header">
                        <h3 className="page-title"> TRADE </h3>
                    </div>
                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="table-responsive">
                                        <table className="table table-hover" id="trade">
                                            <thead>
                                                <tr>
                                                    <th>#SRNO</th>
                                            ...
                                            <tbody>
                                                ...
                                                return payments.payment_mode === 4
                                                }).map((payments) => (
                                                    <tr key={payments.id}>
                                                    <td>{payments.id}</td>
