        ...
        <div className="card-header text-center">
            <div className="row justify-content-between">
                <div className="col-md-4 text-start">
                    ...
                    <p className="d-block text-secondary">tel: +254 (0) 792 902809</p>
                </div>
                <div className="col-lg-3 col-md-7 text-md-end text-start mt-5">
                    <h6 className="d-block mt-2 mb-0">Billed to: {invoiceData.name}</h6>
            ...
            <div className="row justify-content-md-between">
                <div className="col-md-4 mt-auto">
                    <h6 className="mb-0 text-start text-secondary">
                        Invoice no
                    </h6>
                ...
                <div className="col-lg-5 col-md-7 mt-auto">
                    <div className="row mt-md-5 mt-4 text-md-end text-start">
                        <div className="col-md-12">
                            <h6 className="text-secondary mb-0">Invoice date:</h6>
                        ...
                        {invoiceData.invoice_details.length > 0 && (
                            <table className="table text-right">
                                <thead className="bg-default">
                                    <tr>
                                        <th scope="col" className="pe-2 text-start ps-2 text-white" colSpan="4">
                                            OrderNo
                                        </th>
                                        <th scope="col" className="pe-2 text-white" colSpan="4">
                                           Description
                                        </th>
                                        <th scope="col" className="pe-2 text-white" colSpan="4">
                                            Kilos
                                ...
                                <tbody>
                                    {invoiceData.invoice_details.map((detail) => (
                                        <tr key={detail.id}>
                                            <td className="text-start" colSpan="4">{detail.orders.id}</td>
                                            <td className="ps-4" colSpan="4">{detail.orders.comment}</td>
                                            <td className="ps-4" colSpan="4">
                                                {detail.orders.kgs}
                                            </td>
                                        </tr>
                                    ))}
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th></th>
                                        <th></th>
                                        <th className="h5 ps-4" colSpan="5">
                                            Total
                                        </th>
                                        <th colSpan="4" className="text-right h5 ps-4">
