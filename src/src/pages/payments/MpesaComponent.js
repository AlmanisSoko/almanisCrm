...
class MpesaComponent extends React.Component {
            ...
            <div className="main-panel">
                <div className="content-wrapper">
                    ...
                    <div className="page-header">
                        <h3 className="page-title"> MPESA PAYMENTS</h3>
                    </div>
                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="table-responsive">
                                        <table className="table table-hover" id="mpesa">
                                            <thead>
                                                <tr>
                                                    <th>#SRNO</th>
                                            ...
                                            <tbody>
                                                ...
                                                return payments.payment_mode === 2
                                                }).map((payments) => (
                                                    <tr key={payments.id}>
                                                    <td>{payments.id}</td>
